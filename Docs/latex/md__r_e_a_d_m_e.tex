...
Use the Sigma\-Commerce Order Submit A\-P\-I to send new orders from any application directly in to Sigma\-Commerce's Warehouse Management Platform. \begin{DoxyVerb}require_once('scapi.php');
$sc = new SigmaCommerce('companyid', 'username', 'password');
